        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          {
            ...
            value: [
              ...
              `script-src 'self' 'unsafe-inline' https://web.squarecdn.com https://sandbox.web.squarecdn.com${isDev ? " 'unsafe-eval'" : ''}`,
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: blob: https:",
              "font-src 'self' data:",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://web.squarecdn.com https://sandbox.web.squarecdn.com",
