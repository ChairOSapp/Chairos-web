    ...
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="p-5 max-w-2xl mx-auto pb-24">
        <div className="mb-6">
          ...
          <p className="text-neutral-500 text-sm">Your booking alerts and updates</p>
        </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
          {notifications.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <div className="text-xs text-neutral-600 mt-1">New bookings will appear here.</div>
            </div>
          ) : (
            <div className="divide-y divide-neutral-800">
              {notifications.map(n => (
                <div key={n.id}
                  className={`px-5 py-4 flex items-start gap-3 ${!n.read ? 'bg-amber-500/5' : ''}`}>
