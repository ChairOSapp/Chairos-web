...
const ITEMS = [
  ...
  {
    label: 'Earnings',
    href: '/dashboard/barber#earnings',
    icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'
  },
  {
    label: 'Clients',
    href: '/dashboard/barber#clients',
...
export default function BarberMobileNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-neutral-900 border-t border-neutral-800 px-2 py-2 flex justify-around z-50">
      {ITEMS.map((item, i) => {
        const active = pathname === item.href || (item.href !== '/dashboard/barber' && pathname.startsWith(item.href.split('#')[0]))
        return (
          <button key={i}
